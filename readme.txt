...
1. When I first copy the html code from oneUI I found the glyphicons not working as expected, not all of them, just the social ones like si-xxx. I cost time in fixing this. Because you need to find a path to include these fonts so I put all these files in public folder and include them in main.css file.
